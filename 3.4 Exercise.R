...
## Yes, its the same type

# Combine atk and monster into a vector called coerce.check. Check its type and print it, if you need. 
#Try to get the value printed on your screen without typing in the print() command. Can you do that?
